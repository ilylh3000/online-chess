            ...
            redisClient.get(roomId, (err, reply) => {
                ...
                if (reply) {
                    ...
                    if (pawnPromotion) {
                        ...
                        socket
                            .to(roomId)
                            .emit("enemy-moved_castling", castling);
        ...
        redisClient.get(roomId, (err, reply) => {
            ...
            if (reply) {
                ...
                let query = `
                    ...
                    VALUES('${room.time + ""}', '${JSON.stringify(
                    room.moves
        ...
        redisClient.get(roomId, (err, reply) => {
            ...
            if (reply) {
                ...
                db.query(query, (err) => {
                    ...
                    redisClient.set(
                        userOne.username + "-score-updated",
                        "true"
                    );
                    redisClient.set(
                        userTwo.username + "-score-updated",
                        "true"
                    );
                });
            }
